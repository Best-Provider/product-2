    ...
    <div className="relative w-full h-full flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-4 md:py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-center">
          {/* Text Content */}
          <div className="text-white max-w-xl animate__animated animate__bounceInLeft">
            ...
            <Link href="/contact">
              <button className="bg-red-500 hover:bg-red-600 text-white px-6 md:px-8 py-2 md:py-3 rounded-full transition duration-300">

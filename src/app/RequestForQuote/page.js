    ...
    <>
      <div className="w-full min-h-screen relative">
        ...
        <div className="relative z-15 text-center mt-5">
          ...
          {/* Contact Text */}
          <div className="relative mt-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-5xl font-bold text-white bg-none bg-opacity-30 px-6 py-3 rounded-lg shadow-lg">
            Contact Us
          </div>
        </div>
